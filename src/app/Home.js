...
class Home extends Component {
  state = {
    ...
    addresses: [
      ...
      {
        name: "0xcda9fee5839863554a981ff0e96b5d29d1c4e398",
        value: "0xcda9fee5839863554a981ff0e96b5d29d1c4e398"
      },
      {
        name: "0xc97a710576a74e3b79d415d3223ff498ae276009",
        value: "0xc97a710576a74e3b79d415d3223ff498ae276009"
      },
      {
    ...
    search: "0xcda9fee5839863554a981ff0e96b5d29d1c4e398",
    loading: false,
    searchBox: false,
    donation: 0
  };
        ...
        <div className="row justify-content-center">
          <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6">
            ...
            <div className="card p-4 mt-4">
              <div className="form-group">
                <label className="label-control">Contract/DAO Address</label>
                {!this.state.search && (
                  <select
                    className="form-control"
            ...
            <div className="mt-3">
              ...
              <div className="form-group">
                <label className="label-control">Membership</label>
                <input
                  type="text"
                  className="form-control mb-2"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="Link to the description"
                />
                <button
                  className="btn btn-primary btn-block"
